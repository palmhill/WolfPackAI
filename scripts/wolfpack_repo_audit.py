    ...
    def check_appsettings_files(self) -> List[Dict]:
        ...
        for file_path in appsettings_files:
            ...
            try:
                ...
                required_sections = ["LiteLLM", "Postgres", "OpenWebUI", "n8n", "Dashboard"]
                ...
                if "password" in config_str.lower() and ("password123" in config_str.lower() or "changeme" in config_str.lower()):
                    issues.append({
                        "file": str(file_path),
                        "severity": "high",
